...
import (
	...
	"github.com/hiroshi-iwashita/udemy-building-modern-web-applications-with-go/internal/forms"
...
// ReservationSummary get items from session and send to the reservation summary page
